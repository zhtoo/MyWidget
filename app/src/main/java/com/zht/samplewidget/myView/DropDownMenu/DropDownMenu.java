package com.zht.samplewidget.myView.DropDownMenu;
...
//    private int dividerColor = 0xffcccccc;
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        tabMenuView.setDividerDrawable(getResources().getDrawable(R.drawable.drop_menu_divider_line));
        //添加分割线
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            maskView.setVisibility(GONE);
            maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.drop_down_mask_out));
            ...
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    if (current_tab_position == -1) {
                        ...
                        maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.drop_down_mask_in));
