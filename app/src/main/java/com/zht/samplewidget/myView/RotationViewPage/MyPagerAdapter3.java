package com.zht.samplewidget.myView.RotationViewPage;
...
public class MyPagerAdapter3 extends PagerAdapter {
    ...
    public MyPagerAdapter3(int[] data, Context context) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.viewpager_item3, container, false);
