...
import com.zht.samplewidget.myView.DropDownMenu.DropDownMenu;
...
/**
 * Created by ZhangHaitao on 2019/1/2
 */
public class DropDownActivity extends AppCompatActivity {
    ...
    private void initView() {
        View contentView = getLayoutInflater().inflate(R.layout.drop_menu_contentview, null);
    ...
    private View getCustomView() {
        View v = getLayoutInflater().inflate(R.layout.drop_menu_custom, null);
