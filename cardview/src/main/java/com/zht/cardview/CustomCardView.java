...
//        }
    ...
    /**
     * CardView requires to have a particular minimum size to draw shadows before API 21.
     * If developer also sets min width/height, they might be overridden.
     * <p>
    ...
    public CustomCardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mUserSetMinWidth = a.getDimensionPixelSize(R.styleable.CustomCardView_android_minWidth, 0);
        mUserSetMinHeight = a.getDimensionPixelSize(R.styleable.CustomCardView_android_minHeight, 0);
     ...
     * @attr ref R.styleable#CustomCardView_contentPadding
     * @attr ref R.styleable#CustomCardView_contentPaddingLeft
     * @attr ref R.styleable#CustomCardView_contentPaddingTop
     * @attr ref R.styleable#CustomCardView_contentPaddingRight
     * @attr ref R.styleable#CustomCardView_contentPaddingBottom
     */
